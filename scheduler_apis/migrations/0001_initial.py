    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_interviewer', models.BooleanField(default=False, help_text='Check whether the user in interviewer or not', verbose_name='is interviewer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interview_date', models.DateField(default=datetime.date.today, verbose_name='interview_date')),
